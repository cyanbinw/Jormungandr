...
export class WebAddress {
    ...
    public getInvestmentReportForm = this.address + '/v1/Investment/GetInvestmentReportForm'
    ...
    public setInvestmentIsEmptySetWork = this.address + '/v1/Work/InvestmentIsEmptySetWorkREPost'
